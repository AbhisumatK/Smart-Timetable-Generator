          ...
          <div className="content-wrapper">
            ...
            <div className="card max-w-3xl mx-auto">
              ...
              <div className="relative">
                ...
                {showPicker && (
                  <div className="absolute z-20 mt-2 w-full md:w-[38rem] rounded-xl border border-slate-700/60 bg-slate-900/95 backdrop-blur p-4 shadow-xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <div className="text-slate-300 mb-2 font-semibold">Start time</div>
                      ...
                      <div>
                        <div className="text-slate-300 mb-2 font-semibold">End time</div>
                        <div className="grid grid-cols-2 gap-3">
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  ...
                  {timeSlots.length === 0 && (
                    <div className="text-slate-400 text-sm">No time slots added yet.</div>
                  )}
                </div>
              </div>
