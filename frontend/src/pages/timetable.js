    ...
    <>
      ...
      <div className="container max-w-6xl mx-auto mt-12 px-4 sm:px-6 lg:px-8">
        <div className="card p-6 sm:p-8 md:p-10 space-y-6">
          <h2 className={`text-3xl md:text-4xl font-bold tracking-tight bg-gradient-to-r bg-clip-text text-transparent drop-shadow-lg ${
            isDark 
              ? "from-cyan-400 via-blue-400 to-purple-400" 
              : "from-cyan-700 via-blue-700 to-purple-700"
          }`}>Generated Timetable Options</h2>

          {generationError && <p className={isDark ? "text-red-300" : "text-red-700"}>{generationError}</p>}
          {generating && (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              }`}>Generating optimized timetables...</p>
              ...
              {timetableOptions.map((option, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`text-sm mt-1 transition-all duration-200 font-medium ${
                      isSelected
                        ? "text-white/90"
                        : isDark
