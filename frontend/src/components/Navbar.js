...
export default function Navbar() {
  ...
  return (
    <nav className={`w-full sticky top-0 z-40 border-b backdrop-blur-xl shadow-lg transition-all duration-300 ${
      isDark 
      ...
      <div className="container flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2 sm:gap-6">
          <span className={`font-bold text-sm sm:text-lg md:text-xl tracking-tight bg-gradient-to-r bg-clip-text text-transparent cursor-pointer truncate transition-all duration-300 hover:scale-105 ${
            isDark 
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="md:hidden relative" ref={mobileMenuRef}>
            ...
            {mobileMenuOpen && (
              <div className={`absolute right-0 mt-2 w-48 rounded-xl backdrop-blur-xl shadow-2xl py-2 animate-in slide-in-from-top-2 duration-300 ${
                isDark
          ...
          {session ? (
            <div className="relative" ref={menuRef}>
              ...
              >
                ...
                <svg className={`h-4 w-4 transition-all duration-200 ${menuOpen ? "rotate-180" : "rotate-0"} ${
                  isDark
